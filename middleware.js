...
module.exports.isLoggedIn = (req,res,next)=>{
  if(!req.isAuthenticated()){
    //redirect url access and saved in session obj
...
module.exports.isOwner = async(req,res,next)=>{
  ...
  if(req.user.id && !listing.owner._id.equals(res.locals.currUser._id)){
...
module.exports.isReviewAuthor = async(req,res,next)=>{
  ...
  if(req.user.id && !review.author._id.equals(res.locals.currUser._id)){
